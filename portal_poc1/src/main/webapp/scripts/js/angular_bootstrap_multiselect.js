...
angular.module("multiselect.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("multiselect.html",
    ...
    "        ng-style=\"{display: open ? 'block' : 'none'}\" style=\"width: 100%; max-height: 150px; overflow-x: hidden; overflow-y: auto; overflow-x: auto\">\n" +
    "\n" +
...
// line 280 - <li role=\"presentation\" ng-repeat=\"option in unselectedOptions | filter:search() | limitTo: searchLimit\"\n" +
// line 248-     "        ng-style=\"{display: open ? 'block' : 'none'}\" style=\"width: 100%; overflow-x: auto\">\n" +